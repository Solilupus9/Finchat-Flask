...
class Chats(db.Model):
    ...
    pdf_names = db.Column(ARRAY(db.String(120)), nullable=False)
    pdf_urls = db.Column(ARRAY(db.String(120)), nullable=False)
    created_at = db.Column(db.DateTime, nullable=False, default=db.func.now())
    username = db.Column(db.String(120), nullable=False)
    file_keys = db.Column(ARRAY(db.String(120)), nullable=False)
